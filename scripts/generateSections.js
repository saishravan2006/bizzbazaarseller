// Script to generate full sections JSON
// Run: node scripts/generateSections.js
...
const categories = [
    ...
    },
    {
        code: "P10", slug: "BABY_KIDS_AND_MATERNITY", label: "Baby, Kids & Maternity (India)", icon: "baby", items: [
            ...
            { code: "P10.C03", slug: "CLOTHING_AND_ACCESSORIES", icon: "shirt" },
...
fs.writeFileSync(
    path.join(__dirname, '../public/sections_items_full.json'),
    JSON.stringify(output, null, 2)
);

console.log('Generated sections_items_full.json with', sections.length, 'categories');
